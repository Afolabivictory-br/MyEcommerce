...
import { faArrowRightFromBracket, faBagShopping, faCancel, faCartArrowDown, faMagnifyingGlass, faMoon, faStar, faSun, faUser, faUserAlt } from '@fortawesome/free-solid-svg-icons'
      ...
      <div className={style.navbar}>
        ...
        <nav className={theme == 'light' ? style.light : style.dark}>
              ...
              <div className={style.right}>
                  ...
                  <button className={style.theme} onClick={() => setTheme(prevTheme => (prevTheme == 'light' ? 'dark' : 'light'))}><FontAwesomeIcon icon={theme == 'light' ? faSun : faMoon}/></button>{console.log(theme)}
              </div>
          </nav>
      </div>
    </>
